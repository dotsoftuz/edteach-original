...
const PriceCard = (props) => {
  ...
  return (
    <div
      className={`${
        blueBox === 'blue' ? 'bg-blue-600' : ''
      } relative flex flex-col p-8 bg-white rounded-lg border-[1px] shadow-[5px_5px_5px_rgb(147_197_253_/_0.1)]`}
    >
      <div className="flex-1">
        <h3
          className={`${
            blueBox === 'blue' ? '!text-white' : ''
        ...
        <ul role="list" className="pt-6 mt-6 space-y-6 border-t">
          ...
          <li className={text1 ? 'flex' : 'hidden'}>
            <div
              className={`${
                blueBox === 'blue' ? '!bg-white' : ''
              } inline-flex items-center min-w-[1.5rem] w-[1.5rem] h-6 bg-blue-600 rounded-xl`}
            >
              <svg
                className={`${
                  blueBox === 'blue' ? '!text-blue-600' : ''
                } flex-shrink-0 w-4 h-4 mx-auto text-white`}
