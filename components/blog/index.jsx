        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:gap-10">
          ...
          <div className="w-full duration-200 hover:scale-95">
            ...
            <div className="rounded-b-xl px-5 pb-5 pt-3 shadow-md shadow-blue-500/10">
              <div className="">
                ...
                <a
                  href="#"
                  className="block pt-4 font-medium capitalize text-slate-800 hover:text-blue-500"
                >
          ...
          <div className="w-full duration-200 hover:scale-95">
            ...
            <div className="rounded-b-xl px-5 pb-5 pt-3 shadow-md shadow-blue-500/10">
              <div className="">
                <Link href="#">
                  <a className="mr-2 rounded-md bg-blue-50 px-3 py-1 text-sm text-slate-600">
                    Services
                  </a>
                </Link>
                <Link href="#">
                ...
                <Link href="#">
                  <a className="block pt-4 font-medium capitalize text-slate-800 hover:text-blue-500">
