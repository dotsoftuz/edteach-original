  ...
  return (
    <header className="container mx-auto py-4">
      <div className="flex items-center justify-between">
        <Link href="/">
          <a title="Kutty Home Page" className="flex items-center">
            <svg
        ...
        <div className="flex items-center space-x-1">
          <div className="hidden space-x-1 md:inline-flex">
            <Link href="#">
              <a className="btn btn-sm btn-link">Features</a>
            </Link>
            <Link href="#">
              <a className="btn btn-sm btn-link">Pricing</a>
            </Link>
            <Link href="#">
              <a className="btn btn-sm btn-link">Blog</a>
            </Link>
            <Link href="#">
          ...
          <div className="inline-flex md:hidden" x-data="{ open: false }">
            ...
            <div className="absolute top-0 left-0 right-0 z-50 flex flex-col p-2 pb-4 m-2 space-y-3 bg-white rounded shadow">
              ...
              <Link href="#">
                <a className="w-full btn btn-link">Features</a>
              </Link>
              <Link href="#">
                <a className="w-full btn btn-link">Pricing</a>
              </Link>
              <Link href="#">
                <a className="w-full btn btn-link">Blog</a>
              </Link>
              <Link href="#">
                <a className="w-full btn btn-link">Company</a>
              </Link>
              <Link href="#">
                <a className="w-full btn btn-link">Sign in</a>
              </Link>
            </div>
          </div>
        </div>
