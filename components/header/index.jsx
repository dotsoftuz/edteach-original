        ...
        <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
          ...
          <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
            <Link href="/auth">
              <a
                href="#_"
                className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-blue-500 rounded-lg sm:w-auto sm:mb-0 shadow-lg duration-300
