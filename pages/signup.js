...
const SignUp = () => {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 items-center h-screen">
      <div className="w-full px-4 py-20 mx-auto bg-white xl:py-32 md:w-3/5 lg:w-4/5 xl:w-3/5">
        ...
        <div className="mt-8 space-y-10">
          <div className="grid grid-cols-2 gap-4">
            <Link href="#">
              <a className="py-3 btn btn-icon btn-google">
                <svg
            ...
            <Link href="#">
              <a className="py-3 btn btn-icon btn-dark">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
        ...
        <div className="pt-6 mt-6 text-sm font-medium text-gray-700 border-t border-gray-200">
          ...
          <Link href="#">
            <a className="text-purple-700 hover:text-purple-900">Sign Up</a>
          </Link>
        </div>
      </div>
      <div className="px-4 py-20 space-y-10 bg-gray-100 xl:py-32 md:px-40 lg:px-20 xl:px-40">
        <Link href="/">
          <a title="Go to Kutty Home Page">
            <svg
